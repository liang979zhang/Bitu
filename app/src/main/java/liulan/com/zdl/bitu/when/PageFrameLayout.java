package liulan.com.zdl.bitu.when;
...
import liulan.com.zdl.bitu.GuideActivity;
import liulan.com.zdl.bitu.R;
...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
     ...
     * @param layoutIds
     */
    public void setUpViews(AppCompatActivity activity, int layoutIds[], int dot_on, int dot_off) {
        this.dot_on = dot_on;
